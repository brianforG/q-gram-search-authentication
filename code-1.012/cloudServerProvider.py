...
class cloudServerProvider(object):
    ...
    def query(self,s_q,k):
        ...
        for i in range(len(gram_list)):
            #print("representative_grams=%s,e_gram:%s"%(self.representative_grams,e_gram))
        ...
        # print("CSP return (R,S_dic,VO_dic,S_inv,VO_inv,VO_sq) to User")
        return (R,self.S_dic,VO_dic,self.S_inv,VO_inv,VO_sq,VO_construction_time,len(sid_cstr),True)
